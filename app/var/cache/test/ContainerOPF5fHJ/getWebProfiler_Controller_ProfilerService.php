...
class getWebProfiler_Controller_ProfilerService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['web_profiler.controller.profiler'] = new \Symfony\Bundle\WebProfilerBundle\Controller\ProfilerController(($container->services['router'] ?? $container->getRouterService()), ($container->services['profiler'] ?? $container->getProfilerService()), ($container->services['twig'] ?? $container->getTwigService()), $container->parameters['data_collector.templates'], ($container->privates['web_profiler.csp.handler'] ?? $container->load('getWebProfiler_Csp_HandlerService')), \dirname(__DIR__, 4));
    }
}
